...
def create_data_set(plot_list_file_name, root_folder, test_folder, train_folder, no_category_folder, train_data_file_delimeter,train_data_file_no_delimeter):
            ...
            if is_title_line(line):
                ...
                if(len(letters_in_plot)>160):
                    if  file_name in annotated_movies:
                        ...
                        print_train_data_plot(plot_lines,file_name,train_folder,train_data_file_delimeter,train_data_file_no_delimeter,line)                                       
                # reset variables
                title_string = None
                plot_lines = []
                file_name = None
...
create_data_set(PLOT_LIST_FILE_NAME, ROOT_FOLDER, TEST_DATA_FOLDER, TRAIN_DATA_FOLDER, NO_CATEGORY_FOLDER, TRAIN_DATA_FILE_DELIMETER, TRAIN_DATA_FILE_NO_DELIMETER)